    ...
    <div className="flex flex-col gap-4 border-b pb-8">
      ...
      <div className="flex justify-between">
        ...
        <div className="flex items-start gap-4">
          ...
          />
          <div>
            <div className="font-bold hover:underline">{post.author}</div>
            <div className="text-muted-foreground text-sm">
              {post.created_at ? formatTimeAgo(post.created_at) : "방금 전"}
            </div>
          </div>
        </div>
      ...
      <div className="flex gap-2">
        <div className="hover:bg-muted flex cursor-pointer items-center gap-2 rounded-xl b-1 p-2 px-4 text-sm">
